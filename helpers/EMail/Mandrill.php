...
class Mandrill extends \Dachi\Helpers\EMail
{
    ...
    public static function send($options, $mandrill_options = [])
    {
        ...
        $message = [
            ...
            'headers'             => ['Reply-To' => Configuration::get('api.mandrill.default_from_email')],
            'to'                  => [['email' => $options['email'], 'name' => $options['name'], 'type' => 'to']],
        ];
