...
class Database
{
    ...
    public static function getRepository()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'getRepository'], func_get_args());
    }
    ...
    public static function find()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'find'], func_get_args());
    }
    ...
    public static function flush()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'flush'], func_get_args());
    }
    ...
    public static function persist()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'persist'], func_get_args());
    }
    ...
    public static function remove()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'remove'], func_get_args());
    }
    ...
    public static function createQuery()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'createQuery'], func_get_args());
    }
    ...
    public static function createQueryBuilder()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'createQueryBuilder'], func_get_args());
    }
    ...
    public static function createNativeQuery()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'createNativeQuery'], func_get_args());
    }
    ...
    public static function getReference()
    {
        ...
        return call_user_func_array([self::$entity_manager, 'getReference'], func_get_args());
    }
    ...
    {
        return call_user_func_array(["\Doctrine\Common\Util\Debug", 'Dump'], func_get_args());
    }
}
