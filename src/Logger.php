...
class Logger
{
    ...
    {
        set_error_handler(['\Dachi\Core\Logger', 'handle_error']);
        register_shutdown_function(['\Dachi\Core\Logger', 'handle_shutdown']);
    ...
    public static function handle_shutdown()
    {
        ...
        curl_get_contents(Configuration::get('filament.location'), [
            'version'     => 2,
